...
class ResultatHost extends StatelessWidget {
static String routeName = '/ResultatHost';
final String title;
final String content;
final _textController = TextEditingController();

  ResultatHost({Key? key, required this.title, required this.content}) : super(key: key);
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          width: 100,
                          child: const Text('9', textAlign: TextAlign.center, overflow: 
